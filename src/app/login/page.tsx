    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-white">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <h1 className="text-headline text-surface-900 font-display">Welcome back</h1>
          <p className="text-body text-surface-400 mt-2">Sign in to continue your journey.</p>
        </div>
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-white px-4 text-surface-400 text-body-sm">or</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="password" className="block text-body-sm font-medium text-surface-700 mb-1.5">Password</label>
            <input
              id="password"
              type="password"
              className="input-field"
            ...
            <div className="flex justify-end mt-1">
              <Link href="/forgot-password" className="text-accent-600 hover:text-accent-700 font-medium text-body-sm">Forgot password?</Link>
            </div>
          </div>
          <button
            type="submit"
        ...
        <p className="text-center text-body-sm text-surface-400 mt-8">
          ...
          <Link href="/signup" className="text-accent-600 hover:text-accent-700 font-medium">Sign up</Link>
        </p>
      </div>
    </div>
  );
