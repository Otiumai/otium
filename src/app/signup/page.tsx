    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-white">
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          ...
          <h1 className="text-headline text-surface-900 font-display">Create your account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-body-sm font-medium text-surface-700 mb-1.5">Name</label>
            <input
              id="name"
              type="text"
